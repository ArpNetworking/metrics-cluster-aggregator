...
public class CountStatisticTest {
    ...
    public void testGetName() {
        ...
        assertThat(stat.getName(), Matchers.equalTo("count"));
    }
    ...
    public void testCalculate() {
        ...
        assertThat(calculated, Matchers.equalTo(new Quantity.Builder().setValue(3.0).build()));
    }
    ...
    public void testAccumulator() {
        final Accumulator<NullSupportingData> accumulator = (Accumulator<NullSupportingData>) COUNT_STATISTIC.createCalculator();

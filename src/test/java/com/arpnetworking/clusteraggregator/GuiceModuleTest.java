...
/**
 * Tests for the {@link GuiceModule} class.
 *
...
public final class GuiceModuleTest {
    ...
    public void testCreateSinks() throws IOException {
        ...
        final JsonNode testSinkNode = OBJECT_MAPPER.readTree(
                "{\"class\":\"com.arpnetworking.clusteraggregator.GuiceModuleTest$TestSink\"}");
    ...
    public void testSinkDoesNotExist() throws IOException {
        ...
        GuiceModule.createSinks(ImmutableList.of(testSinkNode));
    }
